  ...
  const server = new McpServer({
    ...
    instructions: [
      ...
      ...(cfg.toolProfile === 'read' ? [] : [
        ...
        'If operations were prepared separately (different safe words, or you only later realised they belong together), call prepare_batch with their tokens: it returns one combined preview and ONE server-generated safe word covering all of them, and confirm_mutation with the batch token then runs them in order. list_pending_mutations shows what is still available to batch.',
