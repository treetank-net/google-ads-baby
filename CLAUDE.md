...
### Marketing memory
This plugin no longer wires a separate `marketing-knowledge` MCP server. Use the dedicated `marketing-context-mcp` plugin for durable marketing memory, client context, reviews, preferences, and confirmed mutation notes.
