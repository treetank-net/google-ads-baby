...
- Create Performance Max listing group trees for feed-based campaigns.
...
- Add text asset creation helpers for PMax copy when no reusable text assets
  exist yet.
- Add richer listing group tree templates for feed-based PMax.
...
2. Add richer listing group tree templates for feed-based PMax.
